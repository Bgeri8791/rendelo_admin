...
@section('content')
<h1 class="h3 mb-3">Új páciens</h1>
        ...
        <form action="{{ route('patients.store') }}" method="POST" class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="id_type" class="form-select" required>
                    <option value="TAJ" @selected(old('id_type')==='TAJ')>TAJ</option>
                    <option value="PASSPORT" @selected(old('id_type')==='PASSPORT')>Útlevél</option>
                    <option value="PERSONAL_ID" @selected(old('id_type')==='PERSONAL_ID')>Személyi</option>
                </select>
            </div>
            <div class="col-md-4">
